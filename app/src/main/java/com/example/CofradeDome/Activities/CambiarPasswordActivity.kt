...
class CambiarPasswordActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mainExecutor = ContextCompat.getMainExecutor(this@CambiarPasswordActivity)
        ...
        btn_Guardar = findViewById(R.id.btn_GuardarCambiarContraseña)
                ...
                val updateTask = MiExecutorTask(clienteSSL, object : MiExecutorTask.MiExecutorTaskCallback {
                    override fun onRespuestaRecibida(respuesta: String) {
                        ...
                        if (respuesta.startsWith("Registro actualizado correctamente")) {
                            Toast.makeText(
                                this@CambiarPasswordActivity, // Usa this@ para disambiguar si es necesario
        ...
        btn_Cancelar = findViewById(R.id.btn_CancelarCambiarContraseña)
    ...
    override fun onResume() {
        ...
        if (colorPrincipalPref.length > 0 && rootView != null) {
            ...
            btn_Cancelar!!.setBackgroundColor(obtenerColorPrincipalDesdeNombre(colorPrincipalPref))
        } else {
            Toast.makeText(
                this,
