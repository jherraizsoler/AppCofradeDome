...
class DAOPermisosFragment : Fragment(), View.OnClickListener,
                        ...
                        override fun onActivityResult(resultado: ActivityResult?) {
                            if (resultado?.resultCode == Activity.RESULT_OK) {
                                ...
                                if (idCofrade <= 0 || nivelpermiso < 1 || nivelpermiso > 3 || validarCorreo(
                                    ...
                                    Toast.makeText(
                                        context,
                                        "Error Alta Permiso: Revisa que el idCofrade sea valido (1 | 50), nivel permiso sea valido (1 | 2 | 3) y correo electronico sea valido (usuario@dominio.com)",
                                        Toast.LENGTH_SHORT
                                    ).show()
                                } else {
                                                                                ...
                                                                                if (campos.size == 5) {
                                                                                    ...
                                                                                    lista.add(
                                                                                        DatosPermisoCofrade(
                                                                                            ...
                                                                                            idCofradeSelect,
                                                                                            nivelPermisoSelect,
                                                                                            fechaOtorgamientoSelect,
                                                                                            correoElectronicoSelect
                                                                                        )
                                                                                    )
    ...
    fun clickActualizar(view: View?) {
        if (lista.size == 0) {
            ...
            if (posicionEdicion >= 0 && posicionEdicion < lista.size) {
                ...
                dialog1.setDialogoModificarPermisosCofradeListener(this) // Pasar 'this' como listener
    ...
    override fun permisosC(
        ...
        val fechaOtorgamiento = obtenerFechaActualCalendar()
        val updateCmd =
            "UPDATE CofradesPermisos SET idCofrade = " + idCofrade + ", primerApellido = " + nivelPermiso +
