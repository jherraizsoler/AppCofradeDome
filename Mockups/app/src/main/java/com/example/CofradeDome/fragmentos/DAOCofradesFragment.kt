                    ...
                    override fun onActivityResult(resultado: ActivityResult?) {
                        if (resultado!!.resultCode == Activity.RESULT_OK) {
                            ...
                            if (nombre!!.trim().length < 3 || primerApellido!!.trim().length < 3 || segundoApellido!!.trim().length < 3) {
                                Toast.makeText(
                                    context,
                                    "Error Alta: Revisa que algún campo no este vacío o con menos de 3 caracteres.",
                                    Toast.LENGTH_SHORT
                                ).show()
                            } else {
                                                                ...
                                                                object : MiExecutorTask.MiExecutorTaskCallback {
                                                                    override fun onRespuestaRecibida(respuesta: String) {
                                                                        ...
                                                                        if (respuesta.startsWith("Registro eliminado correctamente")) {
                                                                            ...
                                                                            tvFeedback!!.text = "Registro y asistencias  eliminados correctamente"
                                                                        }else if(respuesta.startsWith("Error SQL al eliminar: 1451 (23000)") && respuesta.contains("CofradesPermisos")){
                                                                            Toast.makeText(this@DAOCofradesFragment.context,"Aviso, no se puede eliminar este cofrade, informe el id de cofade a un administrador.", Toast.LENGTH_LONG).show()
                                                                            tvFeedback!!.text = "Aviso, no se puede eliminar este cofrade, informe el id de cofade a un administrador."
                                                                        }
                                                                    }
                                                                },
                                                                mainExecutor
