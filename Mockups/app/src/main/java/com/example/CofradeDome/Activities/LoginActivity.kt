                            ...
                            if (!respuesta.startsWith("Error SQL") && !respuesta.startsWith("No se ha podido realizar el login contacta con el administrador")) {
                                ...
                                if (registros.size == 1) {
                                    ...
                                    if (BCrypt.checkpw(password, contraseñaBD)) {
                                        ...
                                        tv_feedback?.setText("Error: Contraseña incorrecta")
                                    }
                                } else {
                                    Toast.makeText(
                                        this@LoginActivity,
                                    ...
                                    tv_feedback?.setText("Error: Email incorrecto")
                                }
                            } else {
                                Toast.makeText(
                                    this@LoginActivity,
                                    "Error: No esta registrado este email",
                                    Toast.LENGTH_SHORT
                                ).show()
                            }
                        } catch (e: Exception) {
            ...
            BiometricPrompt(this, executor, object : BiometricPrompt.AuthenticationCallback() {
                ...
                override fun onAuthenticationSucceeded(result: BiometricPrompt.AuthenticationResult) {
                    ...
                    if (encryptedEmail != null) {
                        ...
                        Toast.makeText(
                            this@LoginActivity,
                            "Aviso: No se encontró información cifrada.",
                            Toast.LENGTH_SHORT
                        ).show()
                    }
                }
                ...
                override fun onRespuestaRecibida(respuesta: String) {
                    if (!respuesta.startsWith("Error SQL") && !respuesta.startsWith("No se ha podido realizar el login contacta con el administrador")) {
                        ...
                        if (registros.size == 1) {
                            ...
                            Toast.makeText(this@LoginActivity, "Error: Email incorrecto", Toast.LENGTH_SHORT)
                                .show()
                            tv_feedback?.text = "Error: Email incorrecto"
                        }
                    } else {
                        Toast.makeText(
                            this@LoginActivity,
                        ...
                        tv_feedback?.text = "Error: No esta registrado este email"
                    }
                }
            },
            LoginExecutor
